...
const categories = [
    ...
    {icon: IconMoodSmile, label:"Communciation"},
];
        ...
        <div className="mt-10 sm:mt-20" >
            {categories.map(({icon:Icon,label})=>(
                <div
                    ...
                    border  border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none bg-neutral-900 text-white
                    "
                >
                    <Icon size={40} />
